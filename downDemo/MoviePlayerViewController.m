...
//
//  Created by 李宁 on 14-4-25.
//  Copyright (c) 2014年 VCinema. All rights reserved.
//
...
- (void)viewDidLoad
{
    ...
    [self performSelector:@selector(hidenControlBar) withObject:nil afterDelay:4];
...
- (void)createTopView{
    ...
    [_returnBtn setImage:[UIImage imageNamed:@"btn_back.png"] forState:UIControlStateNormal];
...
- (void)checkForExistingScreenAndInitializeIfPresent {
    if ([[UIScreen screens] count] > 1) {
        ...
        UIWindow*  secondWindow = [[UIWindow alloc]
