...
- (void)viewDidLoad
{
    ...
    [FilesDownManage sharedFilesDownManageWithBasepath:@"DownLoad" TargetPathArr:[NSArray arrayWithObject:@"DownLoad/mp4"]];
       NSArray *onlineBooksUrl = [NSArray arrayWithObjects:@"http://www.jxvdy.com/file/upload/201405/08/11-48-32-19-627.mp4",
    ...
    NSArray *names = [NSArray arrayWithObjects:@"mp4", @"KindleForMac",@"UltraEdit",@"QQ2013SP4",@"QQ2013SP5",@"TM2013",@"QQBrowser",@"QQMusic",@"QQPinyin",nil];
...
- (void)ClickDownBut:(UIButton *)sender {
    ...
    name = [NSString stringWithFormat:@"%@%@",@"111",@".mp4"];
    NSLog(@"Url:%@,Name:%@",urlStr,name);
    [ [FilesDownManage sharedFilesDownManage]downFileUrl:urlStr filename:name filetarget:@"mp4" fileimage:nil];
}
@end
