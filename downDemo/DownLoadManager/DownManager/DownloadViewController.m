...
-(void)play:(FileModel *)selectFile
{
    

    
    NSURL *url = [NSURL fileURLWithPath:selectFile.targetPath];
    NSLog(@"==========%@",url);
    
    movieVC = [[MoviePlayerViewController alloc]initLocalMoviePlayerViewControllerWithURL:url movieTitle:@"111"];
